...
var mobileUrl = adminurl + "mobile/index.html";
  ...
  .factory("NavigationService", function($http, $q, $timeout) {
    ...
    function getRoleSingle(roles) {
      ...
      function addToRoles(objRole) {
        var indexOf = _.findIndex(retRole.roles, function(singleRole) {
          return (
            singleRole.mainMenu == objRole.mainMenu &&
            singleRole.subMenu == objRole.subMenu &&
            singleRole.subThirdMenu == objRole.subThirdMenu
          );
        });
        if (indexOf >= 0) {
          ...
          _.each(objRole, function(singleObj, objKey) {
            if (_.isPlainObject(singleObj)) {
              singleRole[objKey].isExist =
                singleObj.isExist || singleRole[objKey].isExist;
      ...
      _.each(roles, function(role, key) {
        // this is the whole role function
        _.each(role.roles, function(singleRole) {
          // this is single role
    ...
    return {
      ...
      getnav: function() {
        ...
        console.log("Navigation--->", $.jStorage.get("getLoginEmployee").Is);
      ...
      setGlobalAssignmentStatusForMigration: function(data, callback) {
        ...
        $http
          .post(
            adminurl + "Assignment/setGlobalAssignmentStatusForMigration",
            data
          )
          .success(callback);
      },
      ...
      updateEmailStatus: function(data, callback) {
        ...
        $http
          .post(adminurl + "timeline/updateEmailStatus", data)
          .success(callback);
      },
      profile: function(callback, errorCallback) {
        $http
          .post(adminurl + "Employee/getLoginEmployee", data)
      ...
      getInsurer: function(callback) {
        $http
          .post(adminurl + "customerCompany/getInsurer", {})
          .success(callback);
      },
      searchEmployee: function(formData, i, callback) {
        ...
        $http
          .post(adminurl + "Employee/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchInvoice: function(formData, i, callback) {
        $http
          .post(adminurl + "Invoice/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchPayment: function(formData, i, callback) {
        $http
          .post(adminurl + "Payment/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchEmployees: function(formData, i, callback) {
        ...
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Employee/searchEmployee", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchLorCategory: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "LorCategory/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      mobileSubmit: function(formData, callback) {
        console.log("formData : ", formData);
        $http
          .post(adminurl + "Assignment/mobileSubmit", formData)
          .success(function(data) {
            callback(data);
          });
      },
      editSurvey: function(formData, callback) {
        console.log("formData : ", formData);
        $http
          .post(adminurl + "Assignment/editSurvey", formData)
          .success(function(data) {
            callback(data);
          });
      },
      employeeSearch: function(formData, i, callback) {
        ...
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Employee/employeeSearch", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getEmployeeNameEmail: function(formData, i, callback) {
        ...
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Employee/getEmployeeNameEmail", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      getAccordianData: function(callback) {
        $http
          .post(adminurl + "LorCategory/getAccordianData")
          .success(function(data) {
            callback(data);
          });
      },
      ...
      getBackendEmployee: function(formData, i, callback) {
        ...
        $http
          .post(adminurl + "Employee/getBackendEmployee", formData)
          .success(function(data) {
      ...
      getShareWith1: function(formData, i, callback) {
        ...
        // $http.post(adminurl + 'Employee/getBackendEmployee', formData).success(function (data) {
        $http
          .post(adminurl + "Employee/getShareWith1", formData)
          .success(function(data) {
            console.log("FormData in search", data);
            callback(data, i);
          });
      ...
      getBackendEmployeeOnly: function(formData, i, callback) {
        ...
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Employee/getBackendEmployeeOnly", formData)
          .success(function(data) {
            console.log("FormData in search", data);
            callback(data, i);
          });
      ...
      updateNewSurveyor: function(formData, callback) {
        ...
        console.log("formData : ", formData);
        $http
          .post(adminurl + "Assignment/updateNewSurveyor", formData)
          .success(function(data) {
            callback(data);
          });
      },
      removeSurveyor: function(formData, callback) {
        ...
        console.log("formData : ", formData);
        $http
          .post(adminurl + "Assignment/removeSurveyor", formData)
          .success(function(data) {
            callback(data);
          });
      },
      searchAssignment: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getMRNumbers: function(formData, i, callback) {
        ...
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/getMRNumbers", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getMRNames: function(formData, i, callback) {
        formData.ownerId = $.jStorage.get("getLoginEmployee")._id;
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/getMRNames", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchLogistic: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/searchLogistic", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      getOneAssignment: function(formData, i, callback) {
        ...
        console.log("FormData in search", formData);
        $http
          .post(adminurl + "Assignment/getOne", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      getApprovalListIla: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/getApprovalListIla", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getApprovalListLor: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/getApprovalListLor", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getAssignmentApprovalList: function(formData, i, callback) {
        $http
          .post(adminurl + "Assignment/getAssignmentApprovalList", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getInvoiceApprovalList: function(formData, i, callback) {
        $http
          .post(adminurl + "Invoice/getInvoiceApprovalList", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getSurveyorApprovalList: function(formData, i, callback) {
        ...
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/getSurveyorApprovalList", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getSurveyor: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Employee/getSurveyor", formData)
          .success(function(data) {
      ...
      searchPopulatedCity: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "city/populateCityDetails", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      searchPopulatedProduct: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "product/populateProductDetails", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      searchNatureLoss: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "NatureLoss/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getMembership: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Membership/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchInsuredOffice: function(formData, i, callback) {
        ...
        $http
          .post(adminurl + "Customer/getSegmented", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchInsurerOffice: function(formData, i, callback) {
        ...
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "CustomerCompany/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      updateTimeline: function(data, callback) {
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Timeline/updateTimeline", data)
          .success(callback);
      },
      //Nilesh
      saveTimelineAndAssignment: function(id, callback) {
        $http
          .post(adminurl + "timeline/saveTimelineAndAssignment", {
            assignment: id,
      ...
      allDocsRecieved: function(data, callback) {
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/allDocsRecieved", data)
          .success(callback);
      },
      ...
      saveAssignmentTemplate: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/saveTemplate", data)
          .success(callback);
      },
      ...
      sentIlaLorForApproval: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/sentIlaLorForApproval", data)
          .success(callback);
      },
      saveAndRegenerateIlaLor: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/saveAndRegenerateIlaLor", data)
          .success(callback);
      },
      onlyLorForApproval: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/onlyLorForApproval", data)
          .success(callback);
      },
      uploadAssessment: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/uploadAssessment", data)
          .success(callback);
      },
      transferAssignment: function(data, callback) {
        console.log("transferAssignment ", data);
        var email = {
          email: $.jStorage.get("profile").email,
          name: $.jStorage.get("profile").name
        };
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/transferAssignment", data)
          .success(callback);
      },
      calcGlobalAssignmentStatus: function(data, callback) {
        $http
          .post(adminurl + "Assignment/calcGlobalAssignmentStatus", data)
          .success(callback);
      },
      calcAssignmentStatusForInvoiceCreation: function(data, callback) {
        $http
          .post(
            adminurl + "Assignment/calcAssignmentStatusForInvoiceCreation",
            data
          )
          .success(callback);
      },
      ilaLorApproval: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/ilaLorApproval", data)
          .success(callback);
      },
      getPdfPreview: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/getPdfPreview", data)
          .success(callback);
      },
      ...
      saveEmployeeAssignment: function(data, callback) {
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Employee/saveEmployeeAssignment", data)
          .success(callback);
      },
      ...
      updateSurveyor: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/updateSurveyor", data)
          .success(callback);
      },
      submitApprovalForAccessButtons: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/submitApprovalForAccessButtons", data)
          .success(callback);
      },
      submitRequestForAccessButtons: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/submitRequestForAccessButtons", data)
          .success(callback);
      },
      surveyorSentForApproval: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/surveyorSentForApproval", data)
          .success(callback);
      },
      ...
      invoiceApproval: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/invoiceApproval", data)
          .success(callback);
      },
      generateInvoicePreview: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/generateInvoicePreview", data)
          .success(callback);
      },
      changeAssignmentApprovalStatus: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/changeAssignmentApprovalStatus", data)
          .success(callback);
      },
      rejectAssignmentApprovalStatus: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/rejectAssignmentApprovalStatus", data)
          .success(callback);
      },
      searchModel: function(model, formData, i, callback) {
        $http
          .post(adminurl + model + "/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getCustomerProductDetailsAccordingToInvoices: function(
        formData,
        callback
      ) {
        $http
          .post(
            adminurl + "Invoice/getCustomerProductDetailsAccordingToInvoices",
            formData
          )
          .success(function(data) {
            callback(data);
      ...
      getAllAssignment: function(model, formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + model + "/getAll", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getAllInvoices: function(model, formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Invoice/getAll", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getAllCustomer: function(formData, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Customer/getAll", formData)
          .success(function(data) {
            callback(data);
          });
      },
      ...
      searchCustomer: function(formData, i, callback) {
        ...
        $http
          .post(adminurl + "Customer/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchSegment: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Segment/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchMarketing: function(formData, i, callback) {
        $http
          .post(adminurl + "Marketing/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      createInvoice: function(formData, callback) {
        $http
          .post(adminurl + "Invoice/createInvoice", formData)
      ...
      createPayment: function(formData, callback) {
        $http
          .post(adminurl + "Payment/createPayment", formData)
          .success(function(err, data) {
      ...
      getAllItemsName: function(formData, callback) {
        $http
          .post(adminurl + "InvoiceExpenditure/getAllItemsName", formData)
          .success(function(data) {
            callback(data);
          });
      },
      searchInsured: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "CustomerCompany/getInsured", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchInsurer: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "CustomerCompany/getInsurer", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      searchInsurerCustomerCompany1: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "PolicyType/getCompany", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      searchBrokerCustomerCompany: function(formData, i, callback) {
        ...
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "CustomerCompany/getBroker", formData)
          .success(function(data) {
            console.log(data);
            callback(data, i);
          });
      ...
      searchPolicyType: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "PolicyType/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchCountry: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "country/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchCustomerSegment: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "CustomerSegment/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      searchOffice: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "office/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchOfficer: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "officer/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchGetOfficer: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Customer/getOfficer", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getNatureLoss: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "CauseLoss/getNatureLoss", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getAllBranch: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Employee/getAllBranch", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      getPolicyDoc: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "PolicyDoc/getPolicyDoc", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchProduct: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Product/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      searchBranch: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "branch/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      searchTypeOfOffice: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "typeOfOffice/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchCompany: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "company/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      getAttachment: function(formData, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "user/getAttachment", formData)
          .success(function(data) {
            callback(data);
          });
      },
      searchCauseLoss: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "CauseLoss/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchTypeOfClaim: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Claims/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchNatureOfSurvey: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "SurveyCode/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchDepartment: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "department/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchSalvage: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "salvage/search", formData)
          .success(function(data) {
      ...
      searchCategory: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "category/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchIndustry: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "industry/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      pdfGenerate: function(formData, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "user/generateEmailPdf", formData)
          .success(callback);
      },
      searchCurrency: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "currencies/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchInvoiceExpenditure: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "invoiceExpenditure/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchLorMaster: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "lorMaster/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      searchInvoiceExpenditure1: function(formData, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "invoiceExpenditure/searchForInvoiceList", formData)
          .success(function(data) {
            callback(data);
          });
      },
      searchTemplateInvoice: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "TemplateInvoice/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      invoiceExpenditureSave: function(formData, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "invoiceExpenditure/save", formData)
          .success(callback);
      },
      ...
      modelSaveLogistic: function(modal, formData, callback) {
        ...
        $http
          .post(adminurl + modal + "/modelSaveLogistic", formData)
          .success(callback);
      },
      getAssignmentTemplate: function(data, callback) {
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "assignment/getAssignmentTemplate", data)
          .success(callback);
      },
      editAssignmentTemplate: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "assignment/editAssignmentTemplate", data)
          .success(callback);
      },
      ...
      regenerateInvoice: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "invoice/regenerateInvoice", data)
          .success(callback);
      },
      ...
      customerSegmentSave: function(formData, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "CustomerSegment/save", formData)
          .success(callback);
      },
      ...
      getOneinvoiceExpenditure: function(id, callback) {
        $http
          .post(adminurl + "invoiceExpenditure/getOne", {
            _id: id,
            accessToken: $.jStorage.get("accessToken")
          })
          .success(callback);
      ...
      getOneTypeOfOffice: function(id, callback) {
        $http
          .post(adminurl + "TypeOfOffice/getOne", {
            _id: id,
            accessToken: $.jStorage.get("accessToken")
          })
          .success(callback);
      ...
      getOneModel: function(model, id, callback) {
        $http
          .post(adminurl + model + "/getOne", {
            _id: id,
            accessToken: $.jStorage.get("accessToken")
          })
          .success(callback);
      },
      getOneAssignments: function(model, id, callback) {
        $http
          .post(adminurl + "Assignment/getOneAssignment", {
            _id: id,
            accessToken: $.jStorage.get("accessToken")
          })
          .success(callback);
      ...
      invoiceEditData: function(model, id, callback) {
        $http
          .post(adminurl + model + "/invoiceEditData", {
            _id: id,
            accessToken: $.jStorage.get("accessToken")
          })
          .success(callback);
      ...
      getTemplate: function(model, id, callback) {
        $http
          .post(adminurl + model + "/getTemplate", {
            _id: id,
            accessToken: $.jStorage.get("accessToken")
          })
          .success(callback);
      ...
      generateInvoicePdf: function(data, callback) {
        ...
        console.log(data);
        $http
          .post(adminurl + "assignment/generateInvoicePdf", data)
          .success(callback);
      },
      saveInvoiceDraft: function(data, callback) {
        ...
        console.log(data);
        $http
          .post(adminurl + "invoice/saveInvoiceDraft", data)
          .success(callback);
      },
      getExpenditure: function(id, callback) {
        $http
          .post(adminurl + "assignment/getExpenditure", {
            _id: id,
            accessToken: $.jStorage.get("accessToken")
          })
          .success(callback);
      ...
      getOneNatureOfServey: function(id, callback) {
        $http
          .post(adminurl + "SurveyCode/getOne", {
            _id: id,
            accessToken: $.jStorage.get("accessToken")
          })
          .success(callback);
      ...
      searchDistrict: function(formData, i, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "district/search", formData)
          .success(function(data) {
            callback(data, i);
          });
      },
      ...
      getNearerSurveyor: function(formData, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/getNearestSurveyor", formData)
          .success(callback);
      },
      getNearerSurveyor2: function(formData, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/getNearestSurveyor2", formData)
          .success(callback);
      },
      getNearestOffice: function(formData, callback) {
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Office/getNearestOffice", formData)
          .success(callback);
      },
      ...
      getTimeline: function(id, callback) {
        $http
          .post(adminurl + "timeline/getTimeline", {
            assignment: id,
            accessToken: $.jStorage.get("accessToken")
          })
          .success(callback);
      ...
      deleteTypeOfOffice: function(id, callback) {
        $http
          .post(adminurl + "typeOfOffice/delete", {
            _id: id
          })
          .success(callback);
      },
      ...
      rejectILALOR: function(data, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/rejectILALOR", data)
          .success(callback);
      },
      ...
      getEmployeeData: function(id, callback) {
        ...
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Employee/getEmployeeData", data)
          .success(callback);
      },
      ...
      getAssignmentMatchedData: function(data, callback) {
        data.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "Assignment/getAssignmentMatchedData", data)
          .success(callback);
      },
      ...
      getEmployeeOfficeEmail: function(formData, i, callback) {
        ...
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "employee/getEmployeeByOfficeEmail", formData)
      ...
      saveJsonStore: function(data, callback) {
        ...
        formData.accessToken = $.jStorage.get("accessToken");
        $http
          .post(adminurl + "jsonStore/save", formData)
